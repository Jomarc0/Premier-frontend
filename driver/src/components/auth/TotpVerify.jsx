  ...
  return (
    <main className="grid min-h-screen place-items-center bg-page px-4 py-8">
      <section className="grid w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-xl md:grid-cols-[2fr_3fr]">
        <aside className="bg-brand-primary p-8 text-white">
          <div className="grid h-16 w-16 place-items-center rounded-full bg-white text-brand-primary shadow-md">
            <span className="text-lg font-black">PT</span>
          </div>
          <h1 className="mt-6 text-2xl font-black">{BRAND_NAME}</h1>
          <p className="mt-2 text-sm font-semibold text-white/80">{panelLabel}</p>
