...
const KEYS = ["token", "tempToken", "passengerName", "postLoginAction"];
const TOKEN_KEY = "token";
const LAST_ACTIVITY = 'users_last_activity';
const IDLE_MS = 1800000;
...
export function installSessionGuard() {
  ...
  const expire = () => { clear(sessionStorage); location.replace("/login"); };
  const check = () => {
