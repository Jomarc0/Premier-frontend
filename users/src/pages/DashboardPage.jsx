        ...
        <main className="max-w-6xl mx-auto px-4 md:px-8 mt-6 md:mt-8 relative z-20">
            ...
            <div className="lg:col-span-4 space-y-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="w-8 h-8 bg-slate-100 rounded-lg flex items-center justify-center text-[#7A2F3D] shrink-0">
                        <History size={16} />
                    </div>
                    Transaction History
                    </h3>
                    ...
                    className="text-[#7A2F3D] font-bold text-[10px] bg-[#7A2F3D]/5 hover:bg-[#7A2F3D]/10 px-3 py-1.5 rounded-lg transition-colors cursor-pointer uppercase tracking-wider border-none"
                    >
                    See All &rarr;
                    </button>
                </div>
                    ...
                    transactions.map(tx => {
                        ...
                        <div key={tx.id} className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 border border-slate-100/60 transition-all hover:bg-slate-100/80">
                            ...
                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 shadow-2xs ${
                                ...
                                {isCredit ? <Smartphone size={14} /> : <MapPin size={14} className="text-[#7A2F3D]" />}
                            </div>
                            <div>
