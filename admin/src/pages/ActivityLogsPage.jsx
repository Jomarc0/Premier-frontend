    ...
    return (
        <div className="admin-layout">
            ...
            <main className="admin-workspace">
                ...
                {/* Stats */}
                <section className="admin-stats" aria-label="Log statistics">
                    {[
                ...
                <section className="data-panel">
                    <div className="data-panel-header">
                        <span className="data-panel-title">
                            <FiFileText />
                            Activity Logs
                            <span className="count-pill">{totalElements} entries</span>
                        </span>
                        ...
                        <table className="admin-table">
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan={7} className="empty-row">No logs found.</td>
                                    </tr>
                                ) : filtered.map((log) => {
                                    ...
                                    return (
                                        <tr key={log.id}>
                                            ...
                                            <td className="mono" style={{ whiteSpace: 'nowrap' }}>{dt.date}</td>
                                            <td className="mono" style={{ whiteSpace: 'nowrap', color: 'var(--text-muted)' }}>{dt.time}</td>
                                            <td>
                                                <div style={{ fontWeight: 850, color: 'var(--text-main)' }}>
                                                    {log.admin?.username || '—'}
                                                </div>
                                            ...
                                            <td>
                                                <span className="action-tag" style={{ background: actionBg }}>
                                                    {log.action}
                                                </span>
                                            </td>
                                            <td style={{
