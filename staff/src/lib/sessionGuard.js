...
const KEYS = ["premier_staff_session"];
const TOKEN_KEY = "premier_staff_session";
const LAST_ACTIVITY = 'staff_last_activity';
...
export function installSessionGuard() {
  ...
  const expire = () => { clear(sessionStorage); location.replace("/"); };
  const check = () => {
